...
Direct translation of R's neuroim2 MappedNeuroVec class.
"""
...
class MappedNeuroVec(NeuroVec):
    ...
    def __init__(self, source: NeuroVec, 
...
def mapped_neurovecseq(vecs: list, map_fun: Callable,
                      inverse_fun: Optional[Callable] = None) -> MappedNeuroVec:
