...
class TestNeuroVolEdgeCases:
    ...
    def test_extreme_values(self):
        ...
        vol_mixed = DenseNeuroVol(mixed_data.reshape(1, 1, 3), 
                                  NeuroSpace(dim=(1, 1, 3)))
    ...
    def test_integer_overflow_protection(self):
        ...
        data = np.array([[[126, 127], [125, 120]], 
                        [[100, 90], [80, 70]]], dtype=np.int8)
        vol = DenseNeuroVol(data, space)
